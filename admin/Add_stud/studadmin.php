...
<body>
	...
	<div id="wrapper">
		...
		<div class="sidebar">
			...
			<nav>
					<ul class="nav">
							<li><a href="../page-Admin_profile.php"><i class="lnr lnr-home"></i> <span>My Profile</span></a></li>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="../page-Admin_profile.php"><i class="lnr lnr-user"></i> <span>My Profile</span></a></li>
                ...
                <?php
                    ...
                    while($obj = mysqli_fetch_object($result)){
                        ...
                        for($i=0;$i<$result->field_count;$i++){
                         ...
                         echo "<td><a href='upstud.php?r=$obj->rollno'>Update</a></td>";
                         echo "<td><a href='delstud.php?r=$obj->rollno'>Delete</a></td>";
                        echo "</tr>";
                    }
                    ?>
            </div>
