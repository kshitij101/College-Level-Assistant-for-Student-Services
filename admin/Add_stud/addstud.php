...
<form method="POST" action="adds.php" enctype="multipart/form-data" class="form-control">
<?php
...
?>
    ...
    <button class="btn btn-primary" type="submit" value="Add Student">Add Student</button>
</form>
