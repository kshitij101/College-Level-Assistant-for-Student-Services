			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="#" ><i class="lnr lnr-chart-bars"></i> <span>Attendance</span></a></li>
						...
						<li><a href="select_subject.php" class="active"><i class="fa fa-certificate"></i> <span>Grade Prediction</span></a></li>
						...
						<li><a href="../feedback/myprj_tea.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Feedback</span></a></li>
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="page-Student_profile.php"><i class="lnr lnr-user"></i> <span>My Profile</span></a></li>
			...
			<div class="main-content">
				...
				<h3 class="page-title">Attendance System</h3>				
					<div class="row">
						...
						<center><button type="submit" class="btn btn-primary">View Grade</button></center>
						</form>
									</div>
