			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="blog.php" ><i class="fa fa-rss"></i> <span>Blogs</span></a></li>
				...
				<div class="container-fluid">
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span><?php echo $_SESSION['roll_no']?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
								<ul class="dropdown-menu">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="panel-body">
								<div class="clearfix">
								<?php $query1 = mysqli_query($conn,"SELECT tot_ut_com, tot_ut FROM syllabus WHERE course_code='$row->course_code'");
