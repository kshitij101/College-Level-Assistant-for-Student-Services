<?php
	...
	//binding the data
	$query = $conn->prepare("SELECT post_id, user_id, title, LEFT(body,250) AS body, category, file FROM notices order by post_id desc");
	$query->execute();
	$query->bind_result($post_id, $user_id, $title, $body, $category,$file);
?>
<!doctype html>
<html lang="en">
...
<body>
	...
	<div id="wrapper">
		...
		<div class="sidebar">
			<div class="brand">
				<a href="../page-Student_profile.php"><img src="../assets/img/logo.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="../notices/notices.php" class="active"><i class="lnr lnr-code"></i> <span>Notices</span></a></li>
						<li><a href="../timetable/view_tt.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Timetable</span></a></li>
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							?>
							   ...
							   <li><a href="newnotice.php"><i class="fa fa-paper-plane-o"></i><span>New notice</span></a></li>
							...
							<div id="panel" class="panel">
								...
								<div class="panel-body">
									...
									<?php 
										...
										echo "<right><br><br><a title='Click here to download in file.' 
											href='download.php?id=$file'><button class='btn btn-primary'><i class='fa fa-download'></i> </button></a></right>"; 
