<?php
	...
	//include db file
	include('../dbcon.php');
	$query = "SELECT title, body FROM post1 WHERE post_id='$id'";
				...
				<h2 class="page-title">Blog</h2>				
					...
					<!-- TABLE NO PADDING 
							<div id="" class="panel"  style="display:none;">
								<div class="panel-heading">
									<h3 class="panel-title">Todays Total Attendance</h3>
								</div>
								<div class="panel-body no-padding">
									<table class="table">
										...
										<thead>
											<tr>
												<th><p>Percentage of Todays Attendance<span class="label-percent">:80%</span></p>
