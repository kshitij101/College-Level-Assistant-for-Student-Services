	...
	<div id="wrapper">
		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="#" ><i class="lnr lnr-home"></i> <span>Profile</span></a></li>
				...
				<div class="container-fluid">
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../assets/img/user.png" class="img-circle" alt="Avatar"> <span><?php $_SESSION['roll_no'] ?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
								<ul class="dropdown-menu">
...
<h3 class="panel-title">Akkii Blog</h3>
    ...
    <tr>
		...
		<td ><div align="left"><strong>Title</strong></div></td>
		 <td ><input class="form-control" type="text" size="85" maxlength="85" name="title" placeholder ="Title" id="roll_noid2"></tr>
