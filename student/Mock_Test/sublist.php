...
$rs=mysqli_query($conn,"select * from mst_subject");
echo "<div class=panel>
<div class=panel-body no-padding>

";
echo "<h2 class=page-title> Select Subject to Give Test </h2>";
echo "<table class=table>";
while($row=mysqli_fetch_row($rs))
{
	echo "<thead> <tr><td ><a href=showtest.php?subid=$row[0]><font size=4>$row[1]</font></a></td></tr></thead>";
}
echo "</table>
</div>
