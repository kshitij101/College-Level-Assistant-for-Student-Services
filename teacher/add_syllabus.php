<?php
	...
	if (isset($_POST['submit'])) {
		...
		$qry = mysqli_query($conn,"SELECT tot_ut_com FROM syllabus WHERE course_code='$course_code'");
		$row1 = mysqli_fetch_object($qry);
		$unit = $row1->tot_ut_com;
		$ut_com = $unit + 1;
		if($unit>=6)
		{	
			echo '<script language="javascript">'; 
			echo 'alert("I think you teached all the units. Congratulations!!!")';
			echo '</script>';
		}
		else
		{
			
			if($ut_com && $course_code){	
				$query = mysqli_query($conn,"UPDATE `syllabus` SET `tot_ut_com`='$ut_com' WHERE course_code='$course_code'") or die("Noo");
				echo '<script language="javascript">'; 
				echo 'alert("Unit added SUCCESSFULLY.....")';
				echo '</script>';
				echo "<h2></h2>";
...
<!-- WRAPPER -->
				...
				<div class="container-fluid">
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							   ...
							   <li><a href="syllabus.php"><i class="lnr lnr-home"></i><span>View Syllabus</span></a></li>
  ...
  <h1 class="panel-title" align="center">Add Syllabus</h1><br><br>
...
<h3 class="panel-title">Syllabus</h3>
	...
	<table class="table" align="center">
		...
		<td>
		<select class="form-control input-lg" name="course_code">
			<?php
		...
		<tr>
		<td ><div align="left"><strong>Topic:</strong></div></td>
		<td>
		<select class="form-control input-lg" name="topic">
		...
		<td><button type="submit" class="btn btn-default" name="submit" type="submit" id="submit" value="Post"><i class="fa fa-paper-plane-o"></i>  Add</button></td>
	</tr>
	</form>
	</table>
