				...
				<div class="container-fluid">
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="Select_attendance.php"><i class="lnr lnr-chart-bars"></i><span>View Attendance</span></a></li>
						...
						<div class="col-md-6">
							...
							<div id="panel" class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Mark Todays Attendance</h3>
								</div>
								<form action="Attendance_System_added.php" method="POST">
