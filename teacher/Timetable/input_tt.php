			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="#" class="active"><i class="lnr lnr-chart-bars"></i> <span>Timetble</span></a></li>
...
<form action="view_tt.php" method="POST">
  ...
  <table class="table table-bordered">
    ...
    <button type="submit" value="Create TimeTable" class="btn btn-default">Create TimeTable</button>
</form>
</div>
			</div>
			</div>
