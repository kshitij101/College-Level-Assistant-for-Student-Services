<?php
	...
	if (isset($_POST['submit'])) {
		...
		if($title && $post && $cat){	
			$query = mysqli_query($conn,"INSERT INTO post1 (user_id, title, body, category_id, posted) VALUES ('$user_id', '$title', '$post', '$cat', '$date')");
...
<!-- WRAPPER -->
  ...
  <h1 class="panel-title" align="center">Add Blog</h1><br><br>
 
 <div class="panel">
<div class="panel-body">
<div class="panel-heading">
<h3 class="panel-title">Akkii Blog</h3>
</div>
